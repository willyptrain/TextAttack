...
To use TextAttack, you must be running Python 3.6+. Tensorflow needs to be installed. A CUDA-compatible GPU is optional but will greatly improve speed. To install, simply run::
